            ...
            if(check) {
                ...
                if (root.materials != null) {
                    for (var i = 0; i < root.materials.Length; i++) {
                        ...
                        if (fake.VENDOR_materials_characterEmpty == null)
                        {
                            mat.extensions.VENDOR_materials_characterEmpty = null;
                        }
                        if (fake.VENDOR_materials_characterSkinSSS == null)
                        {
                        ...
                        if (fake.VENDOR_materials_characterCornea == null)
                        {
                            mat.extensions.VENDOR_materials_characterCornea = null;
                        }
                        if (fake.VENDOR_materials_characterHairTransparent == null)
                        {
